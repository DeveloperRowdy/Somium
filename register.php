...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql1 = "INSERT INTO cijfers (username) VALUES (?)";
        $sql2 = "INSERT INTO events (username) VALUES (?)";
...
<body>
  ...
  <div id="formContent">
    <!-- Tabs Titles -->
    <h2 class="active"> Registeren </h2>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
                <input type="text" name="username" placeholder="Gebruikersnaam" class="form-control  <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Registeren">

            </div>
            <p>Al een account? <a href="index.php">&nbspKlik hier</a></p>
        </form>
    </div>
</body>
<footer>
